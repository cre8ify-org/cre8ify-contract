...
contract Authorization {
    ...
    modifier onlyRegistered() {
        require(
            ...
            "AppLibrary.User is not registered"
        );
        _;
    }
    ...
    function registerUser(
        ...
        AuthorizationLibrary.registerUser(
            _username,
            _profileImage,
            authorizationVars
        );
    ...
    function getUserDetails(
        ...
        return
            AuthorizationLibrary.getUserDetails(
                _userAddress,
                authorizationVars
            );
    }
    ...
    function getUserAddress(
        ...
        return
            AuthorizationLibrary.getUserAddress(_username, authorizationVars);
    }
    ...
    function checkRegisteredUsers(address _user) external view returns (bool) {
        return
            AuthorizationLibrary.checkRegisteredUsers(_user, authorizationVars);
    }
}
