...
library AuthorizationLibrary {
    ...
    function registerUser(
        ...
        AppLibrary.User memory newUser = AppLibrary.User({
            ...
            badges: new string // Initialize an empty array fdges
        });
        ...
        authorizationVars.userIndexTracker[msg.sender] = authorizationVars
            .userCount;
    ...
    function editProfile(
        ...
        AppLibrary.User storage user = authorizationVars.userDetails[
            msg.sender
        ];
        ...
        authorizationVars
            .registeredUsersArray[
                authorizationVars.userIndexTracker[msg.sender]
            ]
